...
import { DetailsComponent } from 'src/app/SalesGross/details/details.component';
import { SalesReportsComponent } from 'src/app/SalesGross/sales-reports/sales-reports.component';
...
export class DashboardComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.GetData();
    this.apiSrvc.setTitle('Inventory');
